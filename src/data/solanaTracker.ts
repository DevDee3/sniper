...
import { EnrichedTokenData } from "../types.js";
...
export async function fetchTokenEnrichment(
  apiKey: string,
  mint: string
): Promise<EnrichedTokenData | null> {
  if (!apiKey) return null; // enrichment is optional — bot runs fine without it
