...
export class Executor {
    ...
    async buy(mint, sizeSol) {
        try {
            ...
            const { bondingCurveAccountInfo, bondingCurve, associatedUserAccountInfo } = await this.online.fetchBuyState(mintPk, user, TOKEN_PROGRAM_ID);
    ...
    async sellAll(mint, tokenAmount) {
        try {
            ...
            const { bondingCurveAccountInfo, bondingCurve } = await this.online.fetchSellState(mintPk, user, TOKEN_PROGRAM_ID);
